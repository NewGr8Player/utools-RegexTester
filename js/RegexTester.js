...
(function (jch) {
    ...
    (function (RegexTester) {
        ...
        RegexTester.getNewLineChar = getNewLineChar;
        //------------------------------枚举----------------------------
        /**
         * 正则替换模式
         *
        ...
        })(RegexTester.replaceMode || (RegexTester.replaceMode = {}));
        var replaceMode = RegexTester.replaceMode;
        /**
         * RegexTester的工作模式
         *
         * @enum {number}
        ...
        })(RegexTester.workMode || (RegexTester.workMode = {}));
        var workMode = RegexTester.workMode;
        /**
         * 换行符枚举
         *
         * @enum {number}
        ...
        })(RegexTester.newLineChar || (RegexTester.newLineChar = {}));
        var newLineChar = RegexTester.newLineChar;
        /**
         * 正则表达式选项
         *
         * @enum {number}
        ...
        })(RegexTester.RegExpOption || (RegexTester.RegExpOption = {}));
        var RegExpOption = RegexTester.RegExpOption;
    })(RegexTester = jch.RegexTester || (jch.RegexTester = {}));
})(jch || (jch = {}));
